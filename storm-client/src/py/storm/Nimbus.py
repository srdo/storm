...
class getOwnerResourceSummaries_result(object):
    ...
    thrift_spec = (
        (0, TType.LIST, 'success', (TType.STRUCT, (OwnerResourceSummary, OwnerResourceSummary.thrift_spec), False), None, ),  # 0
        (1, TType.STRUCT, 'aze', (AuthorizationException, AuthorizationException.thrift_spec), None, ),  # 1
    )
