...
public class KafkaSpout<K, V> extends BaseRichSpout {
    ...
    private class KafkaSpoutConsumerRebalanceListener implements ConsumerRebalanceListener {
        ...
        private long doSeek(TopicPartition newTp, OffsetAndMetadata committedOffset) {
            ...
            if (committedOffset != null) {
                ...
                if (commitMetadataManager.isOffsetCommittedByThisTopology(newTp, committedOffset, offsetManagers)) {
    ...
    private Map<TopicPartition, OffsetAndMetadata> createOffsetsToCommitForConsumedOffsets(Set<TopicPartition> assignedPartitions) {
